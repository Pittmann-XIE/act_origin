...
import numpy as np
import torch
from .models_variant_c import build_ACT_model, build_CNNMLP_model
...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_dir', action='store', type=str, help='ckpt_dir', default='/home/pengtao/ws_ros2humble-main_lab/act/ckpt_100/policy_epoch_1200_seed_0.ckpt')
    parser.add_argument('--policy_class', action='store', type=str, help='policy_class, capitalize', default='ACT')
    parser.add_argument('--task_name', action='store', type=str, help='task_name', default='sim_pick_place')
