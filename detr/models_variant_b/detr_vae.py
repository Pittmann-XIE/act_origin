...
"""
Variant B ACT model with an action-conditioned future visual simulator.
"""
import copy
...
class DETRVAE(nn.Module):
    ...
    def forward(
        ...
        if run_future and memory is not None and feat_h is not None and feat_w is not None:
