...
def main(args):
    ...
    if policy_class == 'ACT':
        ...
        policy_config = {'lr': args['lr'],
                         ...
                         'backbone': backbone,
                         'dinov3_downsample': dinov3_downsample, # Added config
        ...
        policy_config = {'lr': args['lr'], 'lr_backbone': lr_backbone, 
                         'backbone' : backbone, 'dinov3_downsample': dinov3_downsample, # Added config
...
def forward_pass(data, policy, device='cuda'): # ADDED DEVICE
