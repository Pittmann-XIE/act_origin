...
from utils_bisim import load_data # data functions
from utils_bisim import sample_box_pose, sample_insertion_pose # robot functions
from utils_bisim import compute_dict_mean, set_seed, detach_dict # helper functions
from policy_bisim import ACTPolicy, CNNMLPPolicy
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bisim_weight', action='store', type=float, default=5.0, help='Bisimulation loss weight', required=False)
