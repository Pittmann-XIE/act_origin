...
#SBATCH --gres=gpu:tesla:1             # Request 1 GPU (Required for EGL)
#SBATCH --mem=64G                      # Request 64GB of System RAM
#SBATCH --time=00:20:00                # Max run time (hours)
...
python -u imitate_episodes_variant_a.py \
    ...
    --ckpt_dir /home/fe/xie/act_origin/checkpoints/checkpoints_variant_a_sim_transfer_cube_scripted_top_fpn_dcae_accum16_focus_mask_two_stage/ \
    --policy_class ACT \
    --kl_weight 10 \
    --chunk_size 100 \
    --hidden_dim 512 \
