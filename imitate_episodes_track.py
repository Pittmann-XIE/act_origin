...
def main(args):
    ...
    if policy_class == 'ACT':
        ...
        policy_config = {'lr': args['lr'],
                         ...
                         'layer_to_align': args['layer_to_align'],
...
def forward_pass(data, policy, device='cuda'): 
    # Handle the updated Tuple size from EpisodicDataset (Image, Qpos, Action, Is_Pad, Box, Gaze)
    if len(data) == 6:
        ...
        gaze_data = gaze_data.to(device)
        
        # Pass gaze_data explicitly to the __call__ function
...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer_to_align', action='store', type=int, default=4, help='Which decoder layer to align')
    parser.add_argument('--gaze_weight', action='store', type=float, default=1.0, help='Weight for gaze loss')
